...
local function GetTarget()
    ...
    -- If we already have a valid target and LockOnTarget is enabled, keep that target
    if aimbot.Target and aimbot.Target.Parent and aimbot.Target ~= LocalPlayer and aimbot.Legit.LockOnTarget then
...
-- Print confirmation
print("[COMBINED AIMBOT] Script loaded successfully")
